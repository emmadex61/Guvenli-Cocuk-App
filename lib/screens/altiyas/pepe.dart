...
class pepe extends StatefulWidget {
  const pepe({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _pepeState();
}

class _pepeState extends State {
  get style => null;
  List<Video> videolar = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text("Pepe Bölümler",style: TextStyle(
          color: Colors.white,
            ...
            ListView.builder(
              ...
              itemBuilder: (_, index) {
                ...
                if (model.yasGrubu != null && model.yasGrubu!.contains(6)) {
                  if (model.cartoon != null && model.cartoon.contains('pepe')) {
                    return InkWell(
                      onTap: () {
                        Navigator.push(
                          context,
