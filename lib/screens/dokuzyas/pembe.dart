...
class pembe extends StatefulWidget {
  const pembe({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _pembeState();
}

class _pembeState extends State {
  get style => null;
  List<Video> videolar = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text("Pembe Panter Bölümler",style: TextStyle(
          color: Colors.white,
