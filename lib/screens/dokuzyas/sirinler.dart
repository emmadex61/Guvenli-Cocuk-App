...
class sirinler extends StatefulWidget {
  const sirinler({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _sirinlerState();
}

class _sirinlerState extends State {
  get style => null;
  List<Video> videolar = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text("Şirinler Bölümler",style: TextStyle(
          color: Colors.white,
          ...
          children: <Widget>[
            ...
            ListView.builder(
              ...
              itemBuilder: (_, index) {
                ...
                /// null-safety
                if (model.yasGrubu != null && model.yasGrubu!.contains(9)) {
                  if (model.cartoon != null &&
                      model.cartoon.contains('sirinler')) {
                    return InkWell(
                      onTap: () {
                        Navigator.push(
                          context,
