...
class adventure extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _adventureState();
}

class _adventureState extends State {
  get style => null;
  List<Video> videolar = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text("Adventure Time Bölümler",style: TextStyle(
          color: Colors.white,
              ...
              itemBuilder: (_, index) {
                ...
                if (model.yasGrubu != null && model.yasGrubu!.contains(13)) {
                  if (model.cartoon != null &&
                      model.cartoon.contains('adventure')) {
                    return InkWell(
                      onTap: () {
                        Navigator.push(
                          context,
