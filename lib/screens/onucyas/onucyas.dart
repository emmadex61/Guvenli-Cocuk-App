  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text("13+ Yaş ve Üzeri Çizgi Filmler",style: TextStyle(
          color: Colors.white,
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                    ...
                    child: Text('Gumball',style: TextStyle(
          color: Colors.white,
          fontStyle: FontStyle.italic,
          fontSize: 20,
          ),),
                    onPressed: () => Navigator.push(context,
                        MaterialPageRoute(builder: (context) => gumball()))),
              ],
            ),
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                    ...
                    child: Text('Adveture Time',style: TextStyle(
          color: Colors.white,
          fontStyle: FontStyle.italic,
          fontSize: 20,
          ),),
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                    ...
                    child: Text('Sürekli Dizi'),
                    onPressed: () => Navigator.push(context,
                        MaterialPageRoute(builder: (context) => surekli()))),
              ],
            ),
          ],
        )));
