...
class heidi extends StatefulWidget {
  const heidi({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _heidiState();
}

class _heidiState extends State {
  get style => null;
  List<Video> videolar = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text("Heidi Bölümler",style: TextStyle(
          color: Colors.white,
