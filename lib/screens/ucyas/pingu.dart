...
class pingu extends StatefulWidget {
  const pingu({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _pinguState();
}

class _pinguState extends State {
  get style => null;
  List<Video> videolar = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text("Pingu Bölümler",style: TextStyle(
          color: Colors.white,
